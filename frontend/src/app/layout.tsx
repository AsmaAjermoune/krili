...
import { DarkBackground } from '@/components/ui/background-paths';
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='fr' suppressHydrationWarning>
      ...
      <body className={`${bodyFont.variable} ${displayFont.variable} ${monoFont.variable} ${arabicFont.variable} ${jakartaFont.variable} bg-slate-50 dark:bg-[#0a0a09] text-slate-900 dark:text-[#f2f2f0] antialiased font-sans transition-colors duration-300`}>
        <Providers>
          <DarkBackground />
